                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-12 col-sm-12 col-md-6 mb-2">
                                ...
                                <input type="text" name="fund_transaction_title"
                                    ...
                                    value="{{ old('fund_transaction_title') }}"placeholder="Enter Title...">
                            ...
                            <div class="form-group col-12 col-sm-12 col-md-6 mb-2">
                                ...
                                <input type="date" name="fund_transaction_date"
                                    ...
                                    value="{{ old('fund_transaction_date') }}">
                            ...
                            <div class="form-group col-12 col-sm-12 col-md-6 mb-2">
                                <label for="deposit_source"><b>Amount</b><span class="text-danger">*</span><span
                                ...
                                <input type="number" min="0" name="amount" id="amount"
                                    ...
                                    placeholder="1200 ..."onkeyup="checkAmount(this)">
