            ...
            <div class="row mb-4">
              <div class="col-4">
                <div class="date">
                    ...
                    <span>Date :  {{Carbon\Carbon::parse($loanReturn->transaction_date)->format('d-M-Y')}} </span>
                </div>
              </div>
              <div class="col-4">
            ...
            <table class="table table-bordered border-dark">
                ...
                <tbody>
                    {{-- <tr class="bg-secondary text-light">
                        ...
                        <td class="text-end " colspan="3"> Total  @if($loan->loan_type == 1) Loan Taking @else Loan Giving @endif</td>
                        <td class="text-end">{{number_format($loan->loan_amount,2)}}</td>
                     </tr> --}}
                    {{-- @foreach ($loanReturn as $key => $return) --}}
                        <tr>
                            <td scope="row">1</td>
                            <td class="text-start">{{ $loanReturn->transaction_title }}</td>
                            <td class="text-start">{{$loan->loan_title}} | {{$loan->author->name}} | {!! $loanReturn->description !!}</td>
                            <td class="text-end">{{number_format($loanReturn->amount,2)}}</td>
                         </tr>
                    {{-- @endforeach --}}
                    ...
                    <tr>
                        ...
                        <td class="text-end">
                            <strong>{{ number_format($loanReturn->amount,2) }}</strong>
                        </td>
                    </tr>
                </tbody>
              </table>
