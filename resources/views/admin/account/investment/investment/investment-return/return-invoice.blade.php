...
<head>
    ...
    <title>Investment Return Voucher</title>
        ...
        <div class="container text-center mt-2">
            ...
            <table class="table table-bordered border-dark">
                ...
                <tbody>
                        <tr>
                            <td scope="row">1</td>
                            <td class="text-start">{{ $investment->transaction_title }}</td>
                            <td class="text-start">{{$investmentReturn->transaction_title}} | {{$investment->investor->name}} | {!! $investmentReturn->description !!}</td>
                            <td class="text-end">{{number_format($investmentReturn->amount,2)}}</td>
                         </tr>
                    <tr>
                        ...
                        <td class="text-end">
                            <strong>{{ number_format($investmentReturn->amount,2) }}</strong>
                        </td>
                    </tr>
                </tbody>
              </table>
