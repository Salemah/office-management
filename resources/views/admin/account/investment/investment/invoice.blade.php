        ...
        <div class="container text-center mt-2">
            <div class="row mb-4">
              <div class="col-4">
                <div class="date">
                    ...
                    <span>Date : {{Carbon\Carbon::parse($investment->date)->format('d-M-Y')  }}</span>
                </div>
              </div>
              <div class="col-4">
            ...
            <table class="table table-bordered border-dark">
                ...
                <tbody>
                    <tr>
                        <td scope="row">1</td>
                        <td class="text-start">Investment</td>
                        <td class="text-start">{{$investment->transaction_title}} | {{$investment->investor->name}} | {!! $investment->note !!}</td>
