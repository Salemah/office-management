        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <h6>Total Expense : <b>{{ number_format($totalExpense, 2) ?? '--'}}</b></h6>
                    </div>
                    <div class="col-md-4">
                        <h6>Current Balance : <b>{{ number_format($totalIncome, 2) ?? '--'}}</b></h6>
                    </div>
                </div>
            </div>
        </div>
...
$('#start_date, #end_date').on('change',function(event){
    ...
    $('#search').on('click',function(event){
        ...
        var table =  $('#table').DataTable({
            ...
            {data: 'revenue',name: 'revenue', orderable: true,   searchable: true},
            {data: 'expense',name: 'expense', orderable: true,   searchable: true},
            {data: 'income',name: 'income', orderable: true,   searchable: true},
        ],
        })
