            ...
            <div class="card-body">
                <div class="row d-flex align-items-start border-right">
                    <div class="col-md-2 nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        ...
                        <a class="nav-link" onclick="setTab('receipt')" id="v-pills-receipt-tab" data-coreui-toggle="pill" data-coreui-target="#v-pills-receipt" type="button" role="tab" aria-controls="v-pills-receipt" aria-selected="false">Receive</a>
                        <a class="nav-link" onclick="setTab('receipt-list')" id="v-pills-receipt-list-tab" data-coreui-toggle="pill" data-coreui-target="#v-pills-receipt-list" type="button" role="tab" aria-controls="v-pills-receipt-list" aria-selected="false">Receive List</a>
                    </div>
