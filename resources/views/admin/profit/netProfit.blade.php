...
@section('title', 'monthly net profit')
...
@push('script')
    ...
    <script>
        ...
        function getData(){
            ...
            var url = '{{ route('admin.net.profit',['month' => ':month', 'warehouse' => ':warehouse']) }}';
            ...
            $.ajax({
                ...
                success: function (data) {
                    $('#table-body').empty();
                    $('#table-body').append('<tr><td>' + data.purchase +' tk</td><td>' + data.expense +' tk</td><td>' + data.sell +' tk</td><td>' + data.profit +' tk</td></tr>')
                }
            })
        }
    </script>
