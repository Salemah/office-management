...
@section('content')
    ...
    <form action="{{route('admin.salary.pay',$data->id)}}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row mt-2">
                            ...
                            <div class="row mt-4" id="employee_rows">
                                ...
                                <div class="form-group col-12 col-sm-12 col-md-3 mb-2 bank-way  "
                                     style="display: none">
                        ...
                        <div class="row mt-2">
                            <div class="col-sm-12">
                                <button type="submit" class="btn btn-sm btn-primary mr-2">Confirm Salary</button>
                            </div>
                        </div>
                    </div>
                </div>
