    ...
    <div class="container">
        ...
        <div class="container text-center mt-5">
            <div class="row mb-4">
              <div class="col-4">
                <div class="date">
                    <span> V.NO . <strong>{{$expenseInvoice->expense_invoice_no }}</strong></span><br>
                    <span>Date : {{ $expenseInvoice->expense_invoice_date }}</span>
                </div>
            ...
            <div class="d-flex flex-row my-3">
                <div class="">Expense By : @if(isset($expenseInvoice->expenseBy)){{$expenseInvoice->expenseBy->name }} @endif
            ...
            <div class="container text-center">
                <div class="row">
                  <div class="col-4 ">
                    <div class="pr-3">
                        <p class="approved_by">{{ $expenseInvoice->createdBy->name }}</p>
                        <span class="" >Created By</span>
                    </div>
                  </div>
                  <div class="col-4 ">
                    <div class="ps-3">
                        <p class="approved_by">{{$expenseInvoice->expenseBy->name }}</p>
                        <span class="">Received By</span>
                    </div>
                  </div>
                  <div class="col-4 ">
                    <div class="ps-3">
                        <p class="approved_by">@if($expenseInvoice->status == 2 ){{ $transaction->updatedByUser->name }}@else -- @endif</p>
