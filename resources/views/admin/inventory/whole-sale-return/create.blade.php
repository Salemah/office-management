...
@section('title', 'Whole Sale Return')
...
@section('content')
    ...
    <form action="{{ route('admin.inventory.whole-sale-return.store') }}" enctype="multipart/form-data" method="POST">
        @csrf
        <div class="row">
            <div class="col-md-12">
                <div class="card">
    ...
    <script>
        ...
        var removedItems = [];
         ...
         $(document).on('change', '#product', function () {
            ...
            var url = '{{ route('admin.inventory.wholesale.product.data',':id') }}';
            $.ajax({
                type: "GET",
        ...
        $('#invoice_id').on("change",  function() {
                ...
                $('#purchase').show();
                var url = '{{ route('admin.inventory.whole-sale-return.sale.search', ':id') }}';
                $.ajax({
                    type: 'GET',
