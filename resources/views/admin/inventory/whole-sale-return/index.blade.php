...
@section('breadcrumb')
    <nav aria-label="breadcrumb" class="d-flex align-items-center justify-content-between" style="width: 100%">
        <ol class="breadcrumb my-0 ms-2">
            ...
            <li class="breadcrumb-item">
                <a href="#">Whole Sale Return </a>
            </li>
        </ol>
        <a class="btn btn-sm btn-success text-white" href="{{ route('admin.inventory.whole-sale-return.create') }}">
    ...
    <script>
        $(document).ready(function () {
            ...
            var dTable = $('#table').DataTable({
                ...
                ajax: {
                    url: "{{route('admin.inventory.whole-sale-return.index')}}",
                    type: "get"
                },
                columns: [
        ...
        function deleteItem(id) {
            var url = '{{ route("admin.inventory.whole-sale-return.destroy",":id") }}';
            $.ajax({
                type: "DELETE",
