                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group col-12 col-sm-12 col-md-6 mb-2">
                            ...
                            <input type="file" id="image"data-height="100" name="image"class="dropify form-control @error('image') is-invalid @enderror" data-default-file="{{asset('img/inventory/products/'.$product->image)}}" >
                            @error('image')
                                <span class="alert text-danger" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="row">
                                <div id="variant-section">
                                    @foreach ($productVarient as $key=>$item)
                                        <div class="form-group col-12 col-sm-12 col-md-6 mb-2">
                                            ...
                                            <input type="hidden" name="varId[]" class="form-control" value="{{$item->varients->id}}" placeholder="Enter Vairant Nasme ">
                                        </div>
                                        <div class="form-group col-12 col-sm-12 col-md-6 mb-2">
                                    ...
                                    {{-- end --}}
                                    <div class="form-group col-12 col-sm-12 col-md-6 mb-2">
                                        <button id="addRow" type="button" class="btn btn-sm btn-primary" @if(!$product->is_variant) style="display:none" @endif>Add</button>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6" id="diffPrice-section" @if(!$product->is_diffPrice) style="display:none" @endif>
