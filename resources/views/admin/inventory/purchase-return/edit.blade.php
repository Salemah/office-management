                    ...
                    <div class="card-body">
                        <div class="row">
                                ...
                                <div class="form-group col-12 col-sm-12 col-md-4 mb-2">
                                    ...
                                    {{-- <input type="text" class="form-control @error('invoice_id') is-invalid @enderror"value="{{$return}}" name="invoice_id" id="invoice_id">
                                    <select name="invoice_id" id="invoice_id"class="form-select @error('invoice_id') is-invalid @enderror" readonly>
                                            ...
                                            {{-- @forelse ($invoices as $item) --}}
                                                ...
                                                <input type="hidden" class="form-control @error('invoice_id') is-invalid @enderror"value=" @foreach($invoices as $item) {{$item->invoice_no == $return->invoice_no ? $item->id : '' }} @endforeach" name="invoice_id" id="invoice_id" >
                                                <input type="text" class="form-control @error('invoice_id') is-invalid @enderror"value=" @foreach($invoices as $item) {{$item->invoice_no == $return->invoice_no ? $item->invoice_no : '' }} @endforeach" name="" id="" readonly>
                                           {{-- @empty@endforelse --}}
                                ...
                                <div class="form-group col-12 col-sm-12 col-md-4 mb-2">
                                    ...
                                    <input type="hidden" class="form-control @error('supplier_id') is-invalid @enderror"value=" {{$return->supplier_id}} " name="supplier_id" id="supplier_id" readonly>
                                    <input type="text" class="form-control @error('supplier_id') is-invalid @enderror"value="{{$return->suppliers->name }} " name="" id="" readonly>
                                    {{-- <select name="supplier_id" id="supplier_id" class="form-select @error('supplier_id') is-invalid @enderror" readonly>
                                        <option selected value="{{$return->supplier_id}}">
                                            {{$return->suppliers ? $return->suppliers->name : ''}}
                                        </option>
                                    </select> --}}
                                        @error('supplier_id')
                                            <span class="alert text-danger" role="alert">
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <div >
                                                    <tbody id="purchase_product">
                                                        ...
                                                        <tr>
                                                            <th scope="row">@if($purchase->variant){{ $purchase->variant->value}}{{ $purchase->variant->name}}- @endif{{ $purchase->products->name}}</th>
                                ...
                                <div class="row mt-4">
                                    <div class="col-md-12">
                                        ...
                                        <div class="table-responsive mt-3">
                                            ...
                                            <input type="hidden" name="total_qty"  id="totalQty" value="{{$return->total_qty}}" >
                                            <input type="hidden" name="total"  id="total-val" value="{{$return->grand_total}}" >
                                        </div>
                                    </div>
                                </div>
                                <div class="row mt-3">
         ...
         $(document).on('change', '#product', function () {
            ...
            $.ajax({
                ...
                success: function ( data) {
                    ...
                    if(data[2]){
                       var s =  data[2].value+ data[2].name+'-';
                    }
                    $('#product_data').append('<tr id="responsive-table-tr">'+
                        ...
                        '<td ><input type="hidden" name="product[]" id="product_id-' + x + '" value="' +data[0].id+'" class="form-control" >'+s+data[0].name+'</td>'+
                        '<td>'+data[0].code+'</td>'+
        ...
        function qtyCheck(x){
           // alert(x);
            ...
            if(qty>0){
                $.ajax({
                            type: "GET",
                            url: '{{route('admin.inventory.purchase-return.quantity.search')}}',
                            data: {
                                productId: productId,
                                varId :varId,
                                },
