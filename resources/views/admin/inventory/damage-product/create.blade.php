...
@section('title', 'Add Damage Product')
...
@section('content')
    ...
    <form action="{{ route('admin.inventory.damage-product.store') }}" enctype="multipart/form-data" method="POST">
        @csrf
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                                    ...
                                    @foreach ($products as $key=>$product)
                                        @if($product->is_variant)
                                            @foreach ($product->productVarients as $varient )
                                                <option value="{{$varient->id}},{{$product->id}}">
                            ...
                            <div class="form-group col-12 col-sm-12 col-md-6 mb-2">
                                ...
                                <input type="number" name="quantity" id="qty" class="form-control" oninput="qtyCheck()" placeholder="0.00" step="any">
                                ...
                                <input type="hidden" name="price" id="price" class="form-control" value="" placeholder="0.00" step="any">
                                <input type="hidden" name="subtotal" id="subtotal" class="form-control" value="" placeholder="0.00" step="any">
                                    @error('quantity')
                                        <span class="alert text-danger" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
