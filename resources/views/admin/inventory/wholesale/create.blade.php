...
@section('title', 'Create Whole Sale')
...
@section('breadcrumb')
    <nav aria-label="breadcrumb" class="d-flex align-items-center justify-content-between" style="width: 100%">
        <ol class="breadcrumb my-0 ms-2">
            ...
            <li class="breadcrumb-item">
                 <a href="{{route('admin.inventory.wholesale.index')}}">Whole Sale </a>
            </li>
            <li class="breadcrumb-item">
                 Create
            </li>
        </ol>
        <a href="{{ route('admin.inventory.wholesale.index') }}" class="btn btn-sm btn-dark">Back to list</a>
    </nav>
@endsection
...
@section('content')
    ...
    <form action="{{ route('admin.inventory.wholesale.store') }}" enctype="multipart/form-data" method="POST">
        @csrf
        <div class="row">
            <div class="col-md-12">
                <div class="card">
    ...
    <script>
        ...
        var removedItems = [];
         ...
         $( document ).ready(function() {
            var data =$('#warehouse_id_name').val();
            const myArray = data.slice(0, 4)+ ' - ';
            ...
            $.ajax({
                ...
                success: function ( data) {
                    ...
                    $('#product_data').append('<tr id="responsive-table-tr">'+
                        ...
                        '<td><input type="text" name="price[]" value="'+data[1].wholesale_price+'" id="price-' + x + '" class="form-control"   readonly ></td>'+
