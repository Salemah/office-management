        ...
        <div class="modal-dialog modal-lg" >
          <div class="modal-content">
            ...
            <div class="modal-body modal-edit">
                <form action="{{ route('admin.inventory.wholesale.received.payment') }}" enctype="multipart/form-data" method="POST" >
                    @csrf
                    <div class="row">
    ...
    <script>
        $(document).ready(function () {
            ...
            var dTable = $('#table').DataTable({
                ...
                ajax: {
                    url: "{{route('admin.inventory.wholesale.index')}}",
                    type: "get"
                },
                columns: [
        ...
        function deleteItem(id) {
            var url = '{{ route("admin.inventory.wholesale.destroy",":id") }}';
            $.ajax({
                type: "DELETE",
        ...
        function getSelectedUserData(id) {
            var url = '{{ route('admin.inventory.wholesale.wholesale.search', ':id') }}';
            $.ajax({
                type: "GET",
                url: url.replace(':id', id),
                success: function (resp) {
