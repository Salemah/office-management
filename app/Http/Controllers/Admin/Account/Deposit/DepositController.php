...
class DepositController extends Controller
{
        ...
        try {
            if ($request->ajax()) {
                ...
                if($user_role->name == 'Super Admin' || $user_role->name == 'Admin' ){
                    ...
                    $transactions = Transaction::whereIn('transaction_purpose', [2])->where('warehouse_id',$mystore->id)->latest()->with(['bankAccount','createdByUser'])->get();
                }
    ...
    public function create()
    {
        try {
            ...
            return view('admin.account.deposit.create',compact('bank_accounts','cash_account','warehouses','mystore'));
        } catch (\Exception $exception) {
            return redirect()->back()->with('error', $exception->getMessage());
        }
    }
    ...
    public function edit($id)
    {
        try {
            ...
            return view('admin.account.deposit.edit',compact('transaction','bank_accounts','accountBalance','cash_account','warehouses','mystore'));
        } catch (\Exception $exception) {
   ...
   public function bankAccountSearch(Request $request)
   {
       $result = BankAccount::query()
                ...
                ->where('type', $request->transaction_way)
